            ...
            <div class="box">
                <form action="" method="POST" enctype="multipart/form-data">
                    <select class="input-control" name="kategori" required>
                        ...
                        ?>
                        <option value="<?php echo $r['category_name'] ?>" <?php echo ($r['category_id'] == $p->category_id)? '
                    ...
                    <textarea class="input-control" name="deskripsi" placeholder="Deskirpsi" value="<?php echo $p->product_description ?>"cols="30" rows="10"></textarea><br>
